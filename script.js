...
document.addEventListener('DOMContentLoaded', function() {
    ...
    yesButton.addEventListener('click', function() {
        ...
        box.style.display = 'block'; // Mostra o conteúdo com partículas
        animateParticles();
    
        // Adiciona a opacidade preta após 0.5 segundos (ou qualquer outro tempo de espera)
        setTimeout(function () {
            box.classList.add('hide'); // Adiciona a classe que escurece o fundo
        }, 0);
    ...
    // Função para quando clicar em "Não"
